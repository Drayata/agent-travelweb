    ...
    >
      ...
      <div className="absolute inset-0">
        <img
          ...
          alt="Turquoise ocean waves meeting a pristine sandy beach under golden sunlight"
      ...
      <div className="relative section-container w-full pt-32 pb-20 lg:pt-40 lg:pb-28">
        <div className="max-w-4xl">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/10 backdrop-blur-md border border-white/20 mb-8 animate-fade-in">
            ...
            <div className="flex items-center gap-1.5">
              ...
              <span className="text-white/90 text-sm font-medium">
                Trusted by <strong className="text-white">10,000+</strong> Travelers
              </span>
            </div>
          </div>
          ...
          <p className="text-lg sm:text-xl text-white/70 max-w-2xl leading-relaxed mb-10 animate-fade-in-up" style={{ animationDelay: '200ms' }}>
            Handcrafted itineraries to the world's most breathtaking destinations.
            <br className="hidden sm:block" />
            Zero stress. Zero hidden fees. Just pure wanderlust.
          </p>
          ...
          >
            <div className="flex flex-col sm:flex-row gap-2">
              ...
              {/* Date */}
              <div className="relative flex-1">
                <label htmlFor="search-date" className="sr-only">Travel date</label>
              ...
              <button
                ...
                aria-label="Search available tours"
              >
